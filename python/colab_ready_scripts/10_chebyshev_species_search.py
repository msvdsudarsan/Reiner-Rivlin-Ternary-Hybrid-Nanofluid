...
def solve_spectrum(N, eta_max):
    ...
    # CORRECTED (V33): the species perturbation equation had a sign error
    # in the reaction term (Phi'' - Sc*H0*Phi' - Sc*beta*Phi + gamma*Phi = 0
    # is correct, not +Sc*beta*Phi); see symbolic_derivation/derive_species_sign_check.py
...
print("Paper (V33, corrected sign): N=80,eta_max=20 -> 277.4 | N=120,eta_max=20 -> 410.8 | N=120,eta_max=15 -> 661.9 | N=100,eta_max=25 -> 278.0")
print("Yours:")
for N, eta_max in [(80,20.0),(120,20.0),(120,15.0),(100,25.0)]:
