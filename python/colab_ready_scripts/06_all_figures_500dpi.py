...
# Generates all 6 figures from the paper at 500 DPI and auto-downloads
# them (works in Google Colab; if not running in Colab, files are just
# saved in the current folder instead). Takes about 1-2 minutes total.
