...
flagged across seven review reports: a direct re-solve (not an
interpolated estimate) of the continuation search under an
alternative cross-viscosity closure; a citation-order correction so
